...
async def test_invoice():
    ...
    if response.status_code == 201:
        print("‚úÖ SUCCESS! Invoice created.")
        print(f"Payment Request: {response.json().get('payment_request')}")
    else:
        print("‚ùå FAILED. Please check Alby Dashboard connections.")

if __name__ == "__main__":
    asyncio.run(test_invoice())
Æ
*cascade08"(d4e7a325d0144b3814ef864593774f7a395132062Ifile:///c:/Users/rovie%20segubre/agent/scripts/test_invoice_generation.py:&file:///c:/Users/rovie%20segubre/agent