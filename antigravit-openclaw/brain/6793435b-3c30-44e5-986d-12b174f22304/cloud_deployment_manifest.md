...
- [ ] `gateway_server.py` (The Brain)
- [ ] `polygon_watcher.py` (The Cashier)
- [ ] `wallet_client.py` (The Agent)
...
## 🐳 5. Option C: Docker Deployment (Recommended)
If you have Docker installed, use this for the best experience.

### A. Environment setup
Create a `.env` file on your server (same directory as `docker-compose.yml`):
```bash
MINT_SECRET=your_super_secret
ADMIN_KEY=your_super_secret
OPENROUTER_API_KEY=your_key
ALBY_ACCESS_TOKEN=your_token
SITE_URL=https://your-domain.com
POLYGON_RPC=https://polygon-mainnet.g.alchemy.com/v2/...
MY_WALLET_ADDRESS=0xC8Dc...
```
