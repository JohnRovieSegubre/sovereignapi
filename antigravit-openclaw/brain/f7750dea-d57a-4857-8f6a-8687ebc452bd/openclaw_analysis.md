...
## File Structure
-   `playbook.yml`: The main entry point detecting the OS and invoking roles.
...
-   **Quality:** The code follows best practices (idempotency, variable usage, OS abstraction) and includes comprehensive helper scripts (`install.sh`, `show-lobster.sh`).
