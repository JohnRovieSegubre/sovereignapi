...
When analyzing `ab_test_summary.csv` or `ab_test_trades.csv`, focus on:
...
### `ab_test_summary.csv`
- `config`: Name of the strategy configuration (e.g., `scalper_combo`).
- `win_rate`: Percentage of winning trades.
- `current_equity`: Ending balance (Start $100 + PnL).
...
- `pnl`: Profit or loss on that specific trade.
