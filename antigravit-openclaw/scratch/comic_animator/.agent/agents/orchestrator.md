...
3.  **If major ambiguity:** Ask quick questions, then proceed
...
| `security-lead` | **Security Ops** | **DELEGATE** any Red/Blue team tasks (Metasploit, Audits) |
| `growth-lead` | **Marketing & SEO** | **DELEGATE** any SEO, Social, or Launch tasks |
| `integration-lead` | **APIs & Cloud** | **DELEGATE** Stripe, Firebase, AWS, Discord, Slack |
| `autonomous-lead` | **Agent Building** | **DELEGATE** Loki Mode or new agent creation |
| `creative-lead` | **Art & Animation** | **DELEGATE** Game dev, Manga, Animation, Visuals |
